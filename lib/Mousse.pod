...
L<Mousse> has the same performance qualities as the zippy L<Mouse>.
...
To learn about the features of Mousse (i.e. your generated Mousse-based OO module),
simply read L<Mouse>.
...
then L<Mousse::Maker> will craft a C<lib/Foo/Widget/OO.pm> file for
you from the Mouse parts installed on your system.
...
L<http://github.com/ingydotnet/mousse-pm>.
